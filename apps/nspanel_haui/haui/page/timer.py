...
class TimerPage(HAUIPage):
    ...
    # up and down buttons
    BTN_UP_1, BTN_UP_2, BTN_UP_3, BTN_UP_4 = (10, 'bUp1'), (11, 'bUp2'), (12, 'bUp3'), (13, 'bUp4')
    BTN_DOWN_1, BTN_DOWN_2, BTN_DOWN_3, BTN_DOWN_4 = (14, 'bDown1'), (15, 'bDown2'), (16, 'bDown3'), (17, 'bDown4')
    # buttons
    ...
    def start_panel(self, panel):
        ...
        self.set_function_buttons(
            ...
            self.BTN_FNC_RIGHT_PRI, stop_btn)
        # adjust buttons for timer

        for x in [
            self.BTN_UP_1, self.BTN_UP_2, self.BTN_UP_3, self.BTN_UP_4,
            self.BTN_DOWN_1, self.BTN_DOWN_2, self.BTN_DOWN_3, self.BTN_DOWN_4
        ]:
            ...
            if x == self.BTN_START:
                ...
                if not timer['timer_active']:
                    if minutes != 0 or seconds != 0:
                        ...
                        enabled = False
            color, color_pressed, back_color, back_color_pressed = self.get_button_colors(enabled)
            self.update_function_component(
                x[1], update_fnc_name=fnc_name, visible=True, color=color, color_pressed=color_pressed,
                back_color_pressed=back_color_pressed, icon=icon, touch=enabled)
