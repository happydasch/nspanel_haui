    ...
    content: html`
      <div class="pg-preview-full-col" style="min-height:0;">
        ...
        <div class="pg-preview-btn-row" style="gap:2px;margin-top:2px;">
          <div class="pg-preview-btn" style="width:100%;height:auto;min-height:18px;"><span class="pg-preview-btn-label">${t('DISMISS')}</span></div>
          <div class="pg-preview-btn" style="width:100%;height:auto;min-height:18px;"><span class="pg-preview-btn-label">${t('ACTION')}</span></div>
        </div>
      </div>`,
