...
# device config (per-device settings, one entry per physical NSPanel)
DEVICE_CONFIG: dict[str, Any] = {
    "name": "",
    "panels": [{"type": "clock"}],
    "esphome_device_id": None,  # ESPHome device ID when matched to an existing ESPHome device
    "locale": "en_US",
    # hardware buttons
...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "mqtt": {"topic_prefix": "nspanel_haui_test"},
