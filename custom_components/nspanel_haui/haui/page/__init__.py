...
class HAUIPage(HAUIBase):
    ...
    def set_component_text_color(self, component: tuple, color: int | str | list | tuple) -> None:
    ...
    def set_component_back_color(self, component: tuple, color: int | str | list | tuple) -> None:
