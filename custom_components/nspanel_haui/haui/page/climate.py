...
class ClimatePage(HAUIPage):
    DESCRIPTOR = PageDescriptor(
        ...
        page_name="climate",
        label="Climate",
        description="Climate entity with temperature and mode controls.",
        options=[
            PageOption(key="entity", kind="entity", domain="climate", label="Climate entity"),
        ],
    )
    ...
    def callback_function_component(self, fnc_id, fnc_name) -> None:
        ...
        if fnc_name == "temp_up":
            ...
            if self._climate_entity.get_entity_state() != "off":
                self._climate_entity.call_entity_service(
    ...
    def callback_preset_mode(self, selection) -> None:
        ...
        self._climate_entity.call_entity_service(
            "set_preset_mode", preset_mode=selection
        )
