    ...
    DESCRIPTOR = PageDescriptor(
        ...
        options=[
            ...
            PageOption(
                ...
                kind="select",
                default="en",
                label=_("Clock language"),
                description=_("Language for the word clock text matrix."),
                section=_("Appearance"),
                choices=[("en", _("English")), ("de", _("German")), ("pl", _("Polish"))],
            ),
            PageOption(
                key="show_ampm",
                kind="bool",
                default=False,
                label=_("Show AM/PM"),
                description=_("Show AM/PM indicator on the word clock display."),
                section=_("Time"),
            ),
            PageOption(
                key="show_intro_text",
                kind="bool",
                default=True,
                label=_("Show intro text"),
                description=_("Show intro text ('IT IS') at start of word clock display."),
                section=_("Time"),
            ),
            PageOption(
                ...
                kind="bool",
                default=True,
                label=_("Show intro text on full hour"),
                description=_("Show 'IT IS' text on full hour (e.g. 'IT IS FIVE OCLOCK')."),
                section=_("Time"),
            ),
            PageOption(
                key="off_color",
                kind="color",
                default=8452,
                label=_("Off-letter color"),
                description=_("Default: 8452 (dark gray). Accepts RGB565, [r,g,b], or #rrggbb."),
                section=_("Colors"),
            ),
            PageOption(
                key="letter_color",
                kind="color",
                default=65535,
                label=_("Active letter color"),
                description=_("Default: 65535 (white). Accepts RGB565, [r,g,b], or #rrggbb."),
                section=_("Colors"),
            ),
            PageOption(
                key="special_color",
                kind="color",
                default=62694,
                label=_("Special letter color"),
                description=_("Default: 62694 (amber). Accepts RGB565, [r,g,b], or #rrggbb."),
                section=_("Colors"),
            ),
            PageOption(
                ...
                description=_("Show notification indicator icon on the word clock screen."),
