...
class GridPage(HAUIPage):
    DESCRIPTOR = PageDescriptor(
        ...
        page_name="grid",
        label="Grid",
        description="Grid of up to 6 entity tiles with pagination.",
        options=[
            PageOption(key="initial_page", kind="int", default=0, label="Initial page"),
            PageOption(key="color_seed", kind="int", default=0, label="Color seed (0 = random)"),
            PageOption(key="show_power_button", kind="bool", default=False, label="Show power button"),
            PageOption(
                key="color_mode",
                kind="select",
                default="",
            ...
            PageOption(key="text_color", kind="color", label="Text color"),
            PageOption(key="back_color", kind="color", label="Background color"),
            PageOption(key="color_pressed", kind="color", label="Pressed text color"),
            PageOption(key="back_color_pressed", kind="color", label="Pressed background color"),
            PageOption(key="power_color", kind="color", label="Power button color"),
        ],
    )
