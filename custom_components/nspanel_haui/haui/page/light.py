...
class LightPage(HAUIPage):
    DESCRIPTOR = PageDescriptor(
        ...
        options=[
            ...
            PageOption(key="show_kelvin", kind="bool", default=False, label="Show color temperature in Kelvin"),
        ],
    )
