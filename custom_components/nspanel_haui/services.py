...
def _publish_action(app: NSPanelHAUI, action: ESPAction, value: str) -> None:
    ...
    for dev_name, app in targets:
        ...
        def _do(app=app, dev_name=dev_name) -> None:
            ...
            try:
                ...
                _LOGGER.exception(
                    "%s: failed for '%s'", call.service, dev_name
                )
